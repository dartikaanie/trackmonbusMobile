...
--
-- Host: localhost:3306
-- Generation Time: Aug 17, 2019 at 05:14 AM
...
CREATE TABLE `detail_jadwals` (
  ...
  `user_id_pramugara` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `detail_jadwals` (`tgl`, `no_bus`, `shift_id`, `user_id_pramugara`, `user_id_supir`, `created_at`, `updated_at`, `deleted_at`) VALUES
('2019-07-16', '03', 'pg', '2', '4', '2019-08-08 17:00:00', NULL, NULL),
('2019-08-15', '03', 'sg', '2', '3', '2019-08-08 18:17:19', '2019-06-23 18:17:19', NULL),
('2019-08-16', '02', 'sg', '5', '4', NULL, NULL, NULL),
('2019-08-16', '03', 'pg', '1', '3', NULL, NULL, NULL);
...
CREATE TABLE `jadwals` (
  `tgl` date NOT NULL,
  `no_bus` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `trayek_id` char(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `halte_awal` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `rits` (
  ...
  `tgl` date NOT NULL,
  `no_bus` char(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `halte_tujuan_id` char(4) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `rits` (`rits_id`, `tgl`, `no_bus`, `halte_tujuan_id`, `waktu_berangkat`, `waktu_datang`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
--
-- Dumping data for table `trayek_details`
--

INSERT INTO `trayek_details` (`trayek_id`, `halte_id`, `urut`, `created_at`, `updated_at`, `deleted_at`) VALUES
('1', '1', 1, NULL, NULL, NULL),
('1', '2', 2, NULL, NULL, NULL),
('1', '3', 3, '2019-05-16 21:27:37', '2019-05-16 21:27:37', NULL),
('2', '1', 1, '2019-08-08 17:00:00', NULL, NULL),
('2', '2', 2, '2019-08-08 17:00:00', NULL, NULL);
...
ALTER TABLE `detail_jadwals`
  ...
  ADD KEY `user_id_pramugara` (`user_id_pramugara`,`user_id_supir`),
...
ALTER TABLE `rits`
  ...
  ADD KEY `halte_tujuan_id` (`halte_tujuan_id`),
  ADD KEY `tgl` (`tgl`),
  ADD KEY `no_bus` (`no_bus`);
...
ALTER TABLE `trayek_details`
  ADD PRIMARY KEY (`trayek_id`,`halte_id`),
...
--
ALTER TABLE `detail_jadwals`
  ADD CONSTRAINT `detail_jadwals_ibfk_3` FOREIGN KEY (`user_id_pramugara`) REFERENCES `users` (`user_id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `jadwals`
  ADD CONSTRAINT `jadwals_ibfk_1` FOREIGN KEY (`trayek_id`) REFERENCES `trayeks` (`trayek_id`) ON UPDATE CASCADE,
...
--
ALTER TABLE `rits`
  ADD CONSTRAINT `rits_ibfk_4` FOREIGN KEY (`halte_tujuan_id`) REFERENCES `haltes` (`halte_id`),
...
--
ALTER TABLE `trayek_details`
  ADD CONSTRAINT `trayek_details_ibfk_1` FOREIGN KEY (`halte_id`) REFERENCES `haltes` (`halte_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `trayek_details_ibfk_2` FOREIGN KEY (`trayek_id`) REFERENCES `trayeks` (`trayek_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
